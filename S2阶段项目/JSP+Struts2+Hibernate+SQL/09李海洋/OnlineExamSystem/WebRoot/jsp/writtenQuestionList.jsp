...
<body>
	<div>
		...
		<a href="../file/Template _01.xls"><input type="button"
			value="下载试题模板"></a> <font style="color: red;">仅支持Excel2003版本</font>
	</div>
	<fieldset id="marginTop">
		<table width="100%" align="center" id="marginTop" border="1"
			...
			<tr>
				<th><font>序号</font></th>
				<th><font>类型</font></th>
				<th width="200"><font>题目内容</font></th>
				<th><font>选项A</font></th>
				<th><font>选项B</font></th>
				<th><font>选项C</font></th>
				<th><font>选项D</font></th>
			...
			<s:iterator value="pageBean.Items" var="writtenQuestion"
				status="status">
				<tr>
					...
					<td><a href='javascript:showMsg()'>编辑</a> <a
						href='javascript:showMsg()'>删除</a></td>
				</tr>
			</s:iterator>
		</table>
