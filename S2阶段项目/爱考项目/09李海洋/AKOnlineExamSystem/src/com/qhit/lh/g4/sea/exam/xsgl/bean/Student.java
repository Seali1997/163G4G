package com.qhit.lh.g4.sea.exam.xsgl.bean;
...
public class Student implements java.io.Serializable {
	...
	/** minimal constructor */
	public Student(String sid, String sname, String sex, String enterSchool,
			String ccode) {
		this.sid = sid;
		this.sname = sname;
		this.sex = sex;
	...
	/** full constructor */
	public Student(String sid, String sname, String sex, String enterSchool,
			String ccode, String photo, Date birthday, String idcard,
			String poutlook, String province, String city, String tel,
			String address, String ptel, String prelation, String hostelBuil,
			String hostelNo, String baseInfo, String eduBg, String remarks) {
		this.sid = sid;
		this.sname = sname;
		this.sex = sex;
		this.enterSchool = enterSchool;
